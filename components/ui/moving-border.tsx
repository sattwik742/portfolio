...
export function Button({
  ...
  return (
    <div className="bg-transparent relative h-16 w-44 p-[1px] overflow-hidden" style={{ borderRadius }}>
      ...
      <button
        className={`relative bg-zinc-900/[0.8] border border-white/10 backdrop-blur-xl text-white flex items-center justify-center w-full h-full text-sm antialiased ${className}`}
...
export const MovingBorder = ({ children, duration = 2000 }: any) => {
